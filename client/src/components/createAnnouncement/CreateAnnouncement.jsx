...
export default function CreateAnnouncement({eventId}) {
  ...
  const submitHandler = async (e) => {
    ...
    try {
      await axios.post("/announcements/", newAnnouncement,{headers: {
        'Authorization': 'Bearer ' + localStorage.getItem('token')
      }
      });
    ...
    <div className="share">
      <div className="shareWrapper">
        <div className="shareTop">
          ...
          />
          <input
            placeholder={"What do you have to announce?"}
